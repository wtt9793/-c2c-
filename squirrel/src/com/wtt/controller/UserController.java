...
import com.wtt.service.FocusService;
...
import com.wtt.util.DateUtil;
import com.wtt.util.MD5;
...
//		String num1 = request.getParameter("password");
...
//		}
			if (cur_user != null) {
				...
				if (pwd.equals(cur_user.getPassword())&&code.equals(num)) {
